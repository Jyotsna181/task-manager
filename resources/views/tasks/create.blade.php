...
@section('content')
    <div class="content">
        ...
        <div class="create-box">
            ...
            @endif
            <form action="{{ url('tasks/add-task') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="text" id="fname" name="taskname" placeholder="Task Name..">
                <textarea id="subject" name="description" placeholder="Description" style="height:200px"></textarea>
                <input type="text" id="fname" name="category" placeholder="Category">
